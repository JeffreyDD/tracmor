...
?>
			...
			<table cellpadding="0" cellspacing="0" style="margin-left:10px;" border="0">
				<tr style="height:21px;">
					<td class="shortcut_menu_header_left"><img src="<?php echo __IMAGE_ASSETS__ . '/empty.gif'; ?>" width="5" height="1" /></td>
					<td class="shortcut_menu_header_middle shortcut_menu_header_title">Shortcuts</td>
					<td class="shortcut_menu_header_middle"><img src="<?php echo __IMAGE_ASSETS__ . '/empty.gif'; ?>" width="90" height="1" /></td>
					<td class="shortcut_menu_header_right"><img src="<?php echo __IMAGE_ASSETS__ . '/empty.gif'; ?>" width="5" height="1" /></td>
				</tr>
				<tr>
